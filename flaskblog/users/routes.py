...
from flaskblog.users.utilitites import *
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        return  redirect(url_for('users.login'))
    return render_template('request_reset.html',form=form ,title='Request password')
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('users.login'))
    return render_template('token_reset.html',form=form,title='Reset password')